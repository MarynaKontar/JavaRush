...
public class Solution
{
    public static void main(String[] args)
    {
        ...
        Mouse jerrysmallMouse = new Mouse("SmallJerry", 5 , 2);
        Cat tomCat = new Cat("Tom", 20 , 9);
        Cat tomsmallCat = new Cat("SmallTom", 18 , 7);
        Dog pristonDog = new Dog("Priston", 25 , 15);
        Dog pristonsmallDog = new Dog("SmallPriston", 20, 10);
